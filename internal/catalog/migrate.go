...
func migrate(ctx context.Context, db *sql.DB) (err error) {
	...
	migrations := []migration{{1, initialMigration}, {2, analysisMigration}, {3, workflowMigration}, {4, cohortMigration}, {5, policyMigration}, {6, lifecycleMigration}, {7, sessionsMigration}, {8, syncStateMigration}}
